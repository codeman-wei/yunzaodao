package com.yzd.modules.security.config;

import com.yzd.annotation.AnonymousAccess;
import com.yzd.modules.security.security.JwtAccessDeniedHandler;
import com.yzd.modules.security.security.JwtAuthenticationEntryPoint;
import com.yzd.modules.security.security.TokenConfigurer;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        /*Map.Entry是表示一个映射项（里面有Key和Value），以下是map的一个遍历方式*/
